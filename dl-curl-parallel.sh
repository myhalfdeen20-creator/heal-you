#!/bin/bash
declare -A prompts=(
    ["aisyah"]="Minimalist%20elegant%20faceless%20muslimah%20illustration%2C%20golden%20amber%20hijab%2C%20youthful%20dynamic%20posture%2C%20holding%20a%20classic%20book%2C%20soft%20watercolor%20texture"
    ["hafshah"]="Minimalist%20elegant%20faceless%20muslimah%20illustration%2C%20deep%20blue%20hijab%2C%20disciplined%20focused%20posture%2C%20guarding%20a%20manuscript%2C%20soft%20watercolor%20texture"
    ["ummusalamah"]="Minimalist%20elegant%20faceless%20muslimah%20illustration%2C%20deep%20maroon%20hijab%2C%20wise%20graceful%20posture%2C%20elegant%20and%20calm%2C%20soft%20watercolor%20texture"
    ...
    ["maimunah"]="Minimalist%20elegant%20faceless%20muslimah%20illustration%2C%20muted%20green%20hijab%2C%20humble%20devoted%20posture%2C%20peaceful%20and%20spiritual%2C%20soft%20watercolor%20texture"
)
